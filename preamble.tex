...
\DeclareCaptionLabelFormat{stbfigure}{\\\vspace{\baselineskip}Рисунок \arabic{section}.\arabic{figure}}
...
\setlist[enumerate,1]{itemindent=\parindent + 2.7ex,leftmargin=0ex, nosep}
\setlist[enumerate,2]{itemindent=\parindent + \parindent - 2.7ex, nosep}
...
% Зачем: добавление возможности создания нумерованного списка без точки (1 2 3 ...)
\newenvironment{enumerate_numx}
  {\begin{enumerate}[label=\arabic*, ref=\arabic*, align=left,
    labelindent=\fivecharsapprox,
    leftmargin=*, itemindent=*]}
  {\end{enumerate}}
...
\renewenvironment{equation}{\vspace{0em}\begin{oldequation}}{\end{oldequation}\vspace{0em}}
...
\bibliographystyle{\rootPathPrefix styles/belarus-specific-utf8gost780u}
% Только для магистратуры
...
\newcommand{\fixSectionSpace}{\vspace{-1em}}
