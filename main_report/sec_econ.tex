...
а также инженер-тестировщик, который будет выявлять покрывать программный продукт тестами
с целю выявления ошибок и неисправностей.
...
\FPeval{\valtMonth}{180}

Количество рабочих часов в месяце при 40-часовой рабочей неделе принято равным \num\valtMonth\ часам. Размер премии
...
\FPeval{\valTargetTCh}{round(16.15, \configRoundSigns)}
